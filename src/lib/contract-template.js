    ...
    <div style="font-family:Arial,Helvetica,sans-serif;max-width:700px;margin:0 auto;color:#222;line-height:1.6;padding:20px;">
      ...
      <div style="padding:20px 0;">
        ...
        <ul style="font-size:13px;color:#444;padding-left:20px;margin-bottom:16px;">
          ...
          <li style="margin-bottom:6px;">The remaining balance of <strong>${formatCurrency(balance_amount)}</strong> must be paid no later than the day of the event, before the equipment is unloaded (in the case of tents, on the day of setup).</li>
