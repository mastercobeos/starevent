export const productCards = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'table-round', name: '60" Round Table', nameEs: 'Mesa Redonda de 60"', price: 12.00, desc: '60-inch round folding tables, perfect for banquet-style seating.', descEs: 'Mesas redondas plegables de 60 pulgadas, perfectas para disposición tipo banquete.', image: '/roundtable.png', checkoutLink: '#' },
      { id: 'table-cocktail', name: 'Cocktail Table', nameEs: 'Mesa Cocktail', price: 15.00, desc: 'Elegant cocktail tables perfect for standing receptions and social events.', descEs: 'Elegantes mesas cocktail perfectas para recepciones de pie y eventos sociales.', image: '/cocktailtable.png', checkoutLink: '#' },
    ],
  },
  {
    name: 'Tablecloths',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'tent-20x40', name: 'Tent 20x40', nameEs: 'Carpa 20x40', price: 450.00, desc: '100 people in chairs, 70 seated at tables. Fire proof.', descEs: '100 personas en sillas, 70 en mesas ubicadas. A prueba de fuego.', image: '/tent20x40.png', checkoutLink: '#' },
...
export const deluxePackages = [
  { id: 'pkg-deluxe-20x40', badge: 'Deluxe', price: '$1,299', priceNum: 1299, title: 'Tent 20x40', titleEs: 'Carpa 20x40', image: '/20x40delux.png', includes: ['Draping color in stock', '2 Chandeliers', '7 Rectangular Tables', '7 Tablecloths white or black', '70 Garden Chairs white', 'Garden Lights', '1 Table cake'], checkoutLink: '#' },
  ...
  { id: 'pkg-deluxe-20x20', badge: 'Deluxe', price: '$789', priceNum: 789, title: 'Tent 20x20', titleEs: 'Carpa 20x20', image: '/20x20packagedelux.png', includes: ['Draping color in stock', '1 Chandelier', '3 Rectangular Tables', '3 Tablecloths white or black', '30 Garden Chairs white', 'Garden Lights', '1 Table cake'], checkoutLink: '#' },
];

export const basicPackages = [
  { id: 'pkg-basic-20x40', badge: 'Basic', price: '$849', priceNum: 849, title: 'Tent 20x40', titleEs: 'Carpa 20x40', image: '/20x40packagebasic.png', includes: ['7 Rectangular Tables', '7 Tablecloths white or black', '70 Garden Chairs white', 'Garden Lights', '1 Table cake'], checkoutLink: '#' },
  { id: 'pkg-basic-20x32', badge: 'Basic', price: '$599', priceNum: 599, title: 'Tent 20x32', titleEs: 'Carpa 20x32', image: '/basic20x32.png', includes: ['6 Round Tables', '6 Tablecloths white or black', '48 Garden Chairs white', 'Garden Lights', '1 Table cake'], checkoutLink: '#' },
  { id: 'pkg-basic-20x20', badge: 'Basic', price: '$399', priceNum: 399, title: 'Tent 20x20', titleEs: 'Carpa 20x20', image: '/20x20basic.png', includes: ['3 Rectangular Tables', '3 Tablecloths white or black', '30 Garden Chairs white', 'Garden Lights', '1 Table cake'], checkoutLink: '#' },
];
