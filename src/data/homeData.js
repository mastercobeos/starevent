export const productCards = [
  ...
  },
  {
    ...
    items: [
      { id: 'tent-popup-10x20', name: 'Pop Up Tent 10x20', nameEs: 'Carpa Pop Up 10x20', price: 150.00, desc: 'Compact 10x20 pop-up tent — quick setup, seats up to 16 guests. Includes garden lights. Perfect for small backyard gatherings and intimate events.', descEs: 'Carpa pop-up 10x20 compacta — montaje rápido, acomoda hasta 16 invitados. Incluye luces de jardín. Perfecta para reuniones pequeñas en patio y celebraciones íntimas.', image: '/tent10x20.webp', checkoutLink: '#' },
      { id: 'tent-10x30', name: 'Tent 10x30', nameEs: 'Carpa 10x30', price: 180.00, desc: 'Frame tent 10x30, seats up to 24 guests. Includes garden lights. Ideal for medium gatherings and outdoor parties.', descEs: 'Carpa frame 10x30, acomoda hasta 24 invitados. Incluye luces de jardín. Ideal para reuniones medianas y fiestas al aire libre.', image: '/tent10x30.webp', checkoutLink: '#' },
      { id: 'tent-10x40', name: 'Tent 10x40', nameEs: 'Carpa 10x40', price: 250.00, desc: 'Frame tent 10x40, seats up to 32 guests. Includes garden lights. Great for larger backyard events and celebrations.', descEs: 'Carpa frame 10x40, acomoda hasta 32 invitados. Incluye luces de jardín. Ideal para eventos más grandes en patio y celebraciones.', image: '/tent10x40.webp', checkoutLink: '#' },
      { id: 'tent-20x20', name: 'Tent 20x20', nameEs: 'Carpa 20x20', price: 250.00, desc: 'Perfect for intimate gatherings of up to 30 guests. Includes garden lights.', descEs: 'Perfecta para reuniones íntimas de hasta 30 invitados. Incluye luces de jardín.', image: '/tent20x2040.webp', checkoutLink: '#' },
      ...
      { id: 'tent-20x32', name: 'Tent 20x32', nameEs: 'Carpa 20x32', price: 350.00, desc: '70 people seated in chairs, 50 seated at tables. Fire proof. Includes garden lights.', descEs: '70 personas sentadas en sillas, 50 personas en mesas. A prueba de fuego. Incluye luces de jardín.', image: '/tent20x32.webp', checkoutLink: '#' },
      { id: 'tent-20x40', name: 'Tent 20x40', nameEs: 'Carpa 20x40', price: 450.00, desc: '100 people in chairs, 70 seated at tables. Fire proof. Includes garden lights.', descEs: '100 personas en sillas, 70 en mesas ubicadas. A prueba de fuego. Incluye luces de jardín.', image: '/tent20x40.webp', checkoutLink: '#' },
